...
import TwoFactorWrapper from "./route/TwoFactorWrapper";
import TFAVerificationCode from "./pages/pre-built/tfa";
...
const App = (props) => {
  return (
    <Switch>
      ...
      <Route exact path={`${process.env.PUBLIC_URL}/verify-2fa`} component={TFAVerificationCode}></Route>
