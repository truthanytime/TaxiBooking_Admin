...
export const genShortNameForUser=(firstName, lastName) =>{
  if(!firstName) return ;
  let _firstName = firstName[0].toUpperCase() + firstName.slice(1); 
  let _shortName = `${_firstName}  ${lastName[0].toUpperCase()}.`
  return _shortName
}
